<script lang="ts" module>
	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				default:
					'bg-gradient-to-br from-brand-light to-brand text-white hover:from-brand hover:to-brand-active',
				affirmative:
					'bg-affirmative text-affirmative-foreground hover:bg-affirmative-hover focus-visible:ring-affirmative/40',
				outline:
